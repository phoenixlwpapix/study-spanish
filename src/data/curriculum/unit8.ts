...
export const unit8: Unit = {
  ...
  subtitle: '4 selected lessons from topics 85 and 90–91: Que and core commands',
  description: 'A condensed unit covering the relative pronoun que plus formal and informal tú commands. Other relative pronouns, command forms, and pronoun-placement topics remain planned.',
  ...
  lessons: [
    ...
    // -------------------------------------------------------------
    {
      ...
      unitId: 8,
      order: 90,
      title: '90. Formal Commands (Ud. / Uds.)',
    ...
    // -------------------------------------------------------------
    {
      ...
      unitId: 8,
      order: 91.1,
      title: '91A. Informal "Tú" Commands: Affirmative',
    ...
    // -------------------------------------------------------------
    {
      ...
      unitId: 8,
      order: 91.2,
      title: '91B. Informal "Tú" Commands: Negative',
  ...
  masteryExam: {
    id: 'u8-exam',
    title: 'Unit 8 Selected Topics Checkpoint',
    description: 'A short checkpoint covering representative relative-pronoun and command topics from this condensed unit.',
    passingScore: 80,
    exercises: [
      {
        id: 'u8-ex-1',
