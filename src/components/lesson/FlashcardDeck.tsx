  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      ...
      <div 
        ...
        className="relative h-72 sm:h-80 w-full select-none group"
      >
        <div 
          style={{
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-400">
              ...
              <span>Use the Flip Card button below to reveal the answer</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-1.5 text-xs font-semibold text-indigo-600">
              ...
              <span>Use the Show Front button below to flip back</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-4 pt-2">
        <button
          onClick={handlePrev}
          className="flex-1 py-3 rounded-2xl bg-white hover:bg-slate-100 border border-slate-200 font-bold text-slate-700 flex items-center justify-center gap-2 shadow-xs transition-colors cursor-pointer"
        >
        ...
        <button
          onClick={handleFlip}
          className="px-6 py-3 rounded-2xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold text-sm border border-indigo-200 transition-colors cursor-pointer"
        >
        ...
        <button
          onClick={handleNext}
          className="flex-1 py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold flex items-center justify-center gap-2 shadow-md shadow-indigo-600/20 transition-colors cursor-pointer"
        >
          <span>Next</span>
